...
const VideoCarousel = () => {
  ...
  useEffect(() => {
   if(loadedData.length > 3){
    if(!isPlaying){
        ...
        startPlay ? videoRef.current[videoId].play() : null;
    }
   }
  ...
  useEffect(() => {
    ...
    if(span[videoId]){
        ...
        //Video Progress Tracking Updates logic
        if(videoId === 0){
            anim.restart();
        }
         ...
         const animUpdate = () => {
          ...
          if(video){
            anim.progress(video.currentTime / hightlightsSlides[videoId].videoDuration)
          }
      }
  ...
  return (
    <>
            ...
            <div className="video-carousel_container">
              <div
                className="w-full h-full 
                        flex-center rounded-3xl overflow-hidden
                         bg-black"
              >
                ...
                onPlaying={(pre) => ({ ...pre, isPlaying: true})}
      ...
      <div className="flex-center flex-center mt-10">
